...
public interface QuizService extends RemoteService {
    QuestionAndAnswer getQuestion(final String questionId) throws IllegalArgumentException;
    QuestionAndAnswer getNextQuestion() throws IllegalArgumentException;
